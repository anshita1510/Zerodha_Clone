        ...
        <div className="container mb-5 ">
            ...
            <div className="row text-center ">
                ...
                <div className="col-4 p-3 mt-5">
                    ...
                    <p className="text-small text-muted mt-2.5">Systematic trading platform
                        that allows you to create and backtest
                        strategies without coding. </p>

                </div>
                <div className="col-4 p-4 mt-5">
                    <img src="media/images/sensibullLogo.svg" style={{ width: "40%" }} className="mb-2" />
                    <p className="text-small text-muted mt-2.5"> Options trading platform that lets you
                ...
                <div className="col-4 p-3 mt-5">
                    ...
                    <p className="text-small text-muted mt-2.5">Our asset management venture
                ...
                <div className="col-4 p-3 mt-5">
                    ...
                    <p className="text-small text-muted mt-2"> Personalized advice on life
